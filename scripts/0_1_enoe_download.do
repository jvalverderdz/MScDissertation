...
gl root = "D:\Javier\OneDrive - University of Sussex\Sussex\_Dissertation\Data\raw"
...
forvalues i = 20/`anio' {
	forvalues j = 1/4 {
		...
		* Revisamos si existen bases de datos para no volver a bajar
		capture confirm file "COE1T`j'`i'.dta"
		if _rc!=0 {
			*Excepción para 2020-T1
			if `i' == 20 & `j' == 1 {
				copy "https://www.inegi.org.mx/contenidos/programas/enoe/15ymas/microdatos/2020trim1_dta.zip" enoe_n_20`i'_trim`j'_dta.zip
			}
			else {
...
/*
forvalues i = 1/4 {
	shell rd "$bases/2022trim`i'_dta/" /s /q
}
*/
